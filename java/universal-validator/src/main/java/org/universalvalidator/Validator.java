...
public class Validator {
    ...
    public Validator(){
        RuleLoader ruleLoader = new RuleLoader("https://cors.io/?http://nilankamanoj.tk/universal-validator/validation.json");
    ...
    public Map validate(Object object, String form){
        ...
        while( keys.hasNext() ) {
            ...
            if ( relatedRules.get(key) instanceof JSONObject ) {
                ...
                if(ruleKeys.contains("required") && rule.get("required") instanceof Boolean && (Boolean)rule.get("required")==true){
